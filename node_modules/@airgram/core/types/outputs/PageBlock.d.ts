import { Animation, Audio, ChatPhoto, Location, PageBlockCaption, PageBlockListItem, PageBlockRelatedArticle, PageBlockTableCell, Photo, RichTextUnion, Video } from './index';
/** Describes a block of an instant view web page */
export declare type PageBlockUnion = PageBlockTitle | PageBlockSubtitle | PageBlockAuthorDate | PageBlockHeader | PageBlockSubheader | PageBlockKicker | PageBlockParagraph | PageBlockPreformatted | PageBlockFooter | PageBlockDivider | PageBlockAnchor | PageBlockList | PageBlockBlockQuote | PageBlockPullQuote | PageBlockAnimation | PageBlockAudio | PageBlockPhoto | PageBlockVideo | PageBlockCover | PageBlockEmbedded | PageBlockEmbeddedPost | PageBlockCollage | PageBlockSlideshow | PageBlockChatLink | PageBlockTable | PageBlockDetails | PageBlockRelatedArticles | PageBlockMap;
/** The title of a page */
