...
export declare type ChatEventActionUnion = ChatEventMessageEdited | ChatEventMessageDeleted | ChatEventPollStopped | ChatEventMessagePinned | ChatEventMessageUnpinned | ChatEventMemberJoined | ChatEventMemberLeft | ChatEventMemberInvited | ChatEventMemberPromoted | ChatEventMemberRestricted | ChatEventTitleChanged | ChatEventPermissionsChanged | ChatEventDescriptionChanged | ChatEventUsernameChanged | ChatEventPhotoChanged | ChatEventInvitesToggled | ChatEventSignMessagesToggled | ChatEventStickerSetChanged | ChatEventIsAllHistoryAvailableToggled;
